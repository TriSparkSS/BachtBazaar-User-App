...
const CreateRequestOffers = () => {
  ...
  const openBidDetail = useCallback(
    (bid: MerchantBidData) => {
      navigation.navigate('MerchantBidDetail', {
        bid,
    ...
    [navigation, params.budget, params.requestId, params.status, params.timeframe, params.title],
  );
